...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_CORRECT = 'users.correct';

    /**
     * the column name for the incorrect field
     */
    const COL_INCORRECT = 'users.incorrect';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Userid', 'Username', 'Email', 'Password', 'Correct', 'Incorrect', ),
        self::TYPE_CAMELNAME     => array('userid', 'username', 'email', 'password', 'correct', 'incorrect', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_USERID, UsersTableMap::COL_USERNAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_CORRECT, UsersTableMap::COL_INCORRECT, ),
        self::TYPE_FIELDNAME     => array('userID', 'username', 'email', 'password', 'correct', 'incorrect', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Userid' => 0, 'Username' => 1, 'Email' => 2, 'Password' => 3, 'Correct' => 4, 'Incorrect' => 5, ),
        self::TYPE_CAMELNAME     => array('userid' => 0, 'username' => 1, 'email' => 2, 'password' => 3, 'correct' => 4, 'incorrect' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_USERID => 0, UsersTableMap::COL_USERNAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_PASSWORD => 3, UsersTableMap::COL_CORRECT => 4, UsersTableMap::COL_INCORRECT => 5, ),
        self::TYPE_FIELDNAME     => array('userID' => 0, 'username' => 1, 'email' => 2, 'password' => 3, 'correct' => 4, 'incorrect' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('incorrect', 'Incorrect', 'INTEGER', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_CORRECT);
            $criteria->addSelectColumn(UsersTableMap::COL_INCORRECT);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.incorrect');
        }
    }
