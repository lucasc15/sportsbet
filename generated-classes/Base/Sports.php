...
abstract class Sports implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SportsTableMap';
    ...
    /**
     * Initializes internal state of Base\Sports object.
     */
    ...
    public function setSport($v)
    {
        ...
        if ($this->sport !== $v) {
            $this->sport = $v;
            $this->modifiedColumns[SportsTableMap::COL_SPORT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SportsTableMap::translateFieldName('Sport', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sport = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = SportsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Sports'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SportsTableMap::COL_SPORT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SportsTableMap::COL_SPORT)) {
            $criteria->add(SportsTableMap::COL_SPORT, $this->sport);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Sports (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Sports Clone of current object.
     * @throws PropelException
     */
     ...
     * @return ObjectCollection|ChildDates[] List of ChildDates objects
     */
    public function getDatessJoinEvents(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildDatesQuery::create(null, $criteria);
