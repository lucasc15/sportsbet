...
abstract class Options implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OptionsTableMap';
    ...
    /**
     * Initializes internal state of Base\Options object.
     */
     ...
     *
     * @return $this|Options The current object, for fluid interface
     */
    ...
    public function setOptionid($v)
    {
        ...
        if ($this->optionid !== $v) {
            $this->optionid = $v;
            $this->modifiedColumns[OptionsTableMap::COL_OPTIONID] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[OptionsTableMap::COL_TEXT] = true;
        }
    ...
    public function setImage($v)
    {
        ...
        if ($this->image !== $v) {
            $this->image = $v;
            $this->modifiedColumns[OptionsTableMap::COL_IMAGE] = true;
        }
    ...
    public function setVotecount($v)
    {
        ...
        if ($this->votecount !== $v) {
            $this->votecount = $v;
            $this->modifiedColumns[OptionsTableMap::COL_VOTECOUNT] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OptionsTableMap::COL_IMAGE)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Options'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Options'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OptionsTableMap::COL_IMAGE)) {
            $criteria->add(OptionsTableMap::COL_IMAGE, $this->image);
        }
        if ($this->isColumnModified(OptionsTableMap::COL_VOTECOUNT)) {
    ...
    {
        $criteria = ChildOptionsQuery::create();
        $criteria->add(OptionsTableMap::COL_OPTIONID, $this->optionid);
    ...
    /**
     * Generic method to set the primary key (optionid column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Options (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setOptionid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Options Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildOptions is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOptions The current object (for fluent API support)
     */
     ...
     * Otherwise if this Options is new, it will return
     * an empty collection; or if this Options has previously
     * been saved, it will retrieve related Votess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Options.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
