...
abstract class Users implements ActiveRecordInterface
{
    ...
    public function setCorrect($v)
    {
        ...
        if ($this->correct !== $v) {
            $this->correct = $v;
            $this->modifiedColumns[UsersTableMap::COL_CORRECT] = true;
        }
     ...
     * @return $this|\Users The current object (for fluent API support)
     */
    public function setIncorrect($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->incorrect !== $v) {
            $this->incorrect = $v;
            $this->modifiedColumns[UsersTableMap::COL_INCORRECT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('Correct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->correct = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('Incorrect', TableMap::TYPE_PHPNAME, $indexType)];
            $this->incorrect = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_CORRECT)) {
            $modifiedColumns[':p' . $index++]  = 'correct';
        }
        if ($this->isColumnModified(UsersTableMap::COL_INCORRECT)) {
            $modifiedColumns[':p' . $index++]  = 'incorrect';
        }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getCorrect(),
            $keys[5] => $this->getIncorrect(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setCorrect($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setIncorrect($arr[$keys[5]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_CORRECT)) {
            $criteria->add(UsersTableMap::COL_CORRECT, $this->correct);
        }
        if ($this->isColumnModified(UsersTableMap::COL_INCORRECT)) {
            $criteria->add(UsersTableMap::COL_INCORRECT, $this->incorrect);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIncorrect($this->getIncorrect());
     ...
     * @return ObjectCollection|ChildVotes[] List of ChildVotes objects
     */
    public function getVotessJoinOptions(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildVotesQuery::create(null, $criteria);
        $query->joinWith('Options', $joinBehavior);
