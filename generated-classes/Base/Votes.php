...
abstract class Votes implements ActiveRecordInterface 
{
    ...
    public function setVoteid($v)
    {
        ...
        if ($this->voteid !== $v) {
            $this->voteid = $v;
            $this->modifiedColumns[VotesTableMap::COL_VOTEID] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[VotesTableMap::COL_USERID] = true;
        }
    ...
    public function setOptionid($v)
    {
        ...
        if ($this->optionid !== $v) {
            $this->optionid = $v;
            $this->modifiedColumns[VotesTableMap::COL_OPTIONID] = true;
        }

        if ($this->aOptions !== null && $this->aOptions->getOptionid() !== $v) {
            $this->aOptions = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aOptions !== null && $this->optionid !== $this->aOptions->getOptionid()) {
            $this->aOptions = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aOptions !== null) {
                if ($this->aOptions->isModified() || $this->aOptions->isNew()) {
                    $affectedRows += $this->aOptions->save($con);
                }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VotesTableMap::COL_OPTIONID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VotesTableMap::COL_OPTIONID)) {
            $criteria->add(VotesTableMap::COL_OPTIONID, $this->optionid);
        }
    ...
    /**
     * Generic method to set the primary key (voteid column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setVoteid(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    /**
     * Declares an association between this object and a ChildOptions object.
     *
     * @param  ChildOptions $v
     * @return $this|\Votes The current object (for fluent API support)
     * @throws PropelException
     */
    public function setOptions(ChildOptions $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildOptions object, it will not be re-added.
        if ($v !== null) {
            $v->addVotes($this);
        }
    ...
    /**
     * Get the associated ChildOptions object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildOptions The associated ChildOptions object.
     * @throws PropelException
     */
    public function getOptions(ConnectionInterface $con = null)
    {
        if ($this->aOptions === null && ($this->optionid !== null)) {
            $this->aOptions = ChildOptionsQuery::create()->findPk($this->optionid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOptions->addVotess($this);
             */
        }
