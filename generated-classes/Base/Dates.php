...
abstract class Dates implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DatesTableMap';
    ...
    /**
     * Initializes internal state of Base\Dates object.
     */
    ...
    /**
     * Compares this with another <code>Dates</code> instance.  If
     * <code>obj</code> is an instance of <code>Dates</code>, delegates to
     * <code>equals(Dates)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Dates The current object, for fluid interface
     */
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[DatesTableMap::COL_DATE] = true;
            }
    ...
    public function setSportid($v)
    {
        ...
        if ($this->sportid !== $v) {
            $this->sportid = $v;
            $this->modifiedColumns[DatesTableMap::COL_SPORTID] = true;
        }
    ...
    public function setEventid($v)
    {
        ...
        if ($this->eventid !== $v) {
            $this->eventid = $v;
            $this->modifiedColumns[DatesTableMap::COL_EVENTID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DatesTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DatesTableMap::translateFieldName('Sportid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sportid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DatesTableMap::translateFieldName('Eventid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = DatesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Dates'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDatesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDatesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DatesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DatesTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(DatesTableMap::COL_SPORTID)) {
            $modifiedColumns[':p' . $index++]  = 'sportID';
        }
        if ($this->isColumnModified(DatesTableMap::COL_EVENTID)) {
            $modifiedColumns[':p' . $index++]  = 'eventID';
        }

        $sql = sprintf(
            'INSERT INTO dates (%s) VALUES (%s)',
    ...
    {
        $pos = DatesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Dates'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Dates'][$this->hashCode()] = true;
        $keys = DatesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDate(),
    ...
    {
        $criteria = new Criteria(DatesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(DatesTableMap::COL_DATE)) {
            $criteria->add(DatesTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(DatesTableMap::COL_SPORTID)) {
            $criteria->add(DatesTableMap::COL_SPORTID, $this->sportid);
        }
        if ($this->isColumnModified(DatesTableMap::COL_EVENTID)) {
            $criteria->add(DatesTableMap::COL_EVENTID, $this->eventid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Dates (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Dates Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aSports) {
            $this->aSports->removeDates($this);
        }
        if (null !== $this->aEvents) {
            $this->aEvents->removeDates($this);
        }
        $this->date = null;
        $this->sportid = null;
        $this->eventid = null;
    ...
    {
        return (string) $this->exportTo(DatesTableMap::DEFAULT_STRING_FORMAT);
    }
